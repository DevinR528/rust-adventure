...
const MSGS: &[&str] = &[
    ...
    "Pretty soon you will update Polonius!!",
];

fn serialize_all_questions() -> io::Result<()> {
    let mut dir = env::current_dir()?;
    dir.push("questions_in");
...
pub fn start_adventure() -> Result<(), io::Error> {
